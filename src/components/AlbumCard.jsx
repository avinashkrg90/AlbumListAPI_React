    ...
    return (
        <>
            <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='hover:scale-105 duration-200 cursor-pointer  rounded-md'>
                <div style={{backgroundImage:`url(${imageArray[Number(`${album.imageId}`)-1]})`, backgroundSize: 'cover'}} className={`py-0 flex flex-col justify-between items-center w-[60vw] sm:w-[260px] h-[60vw] sm:h-[260px] rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.4)]`}>
                    ...
                    <div ref={cardTextRef} className='text-center w-full py-2 sm:py-6 bg-black/10'> 
                        <h2 className='text-white text-md sm:text-lg italic font-semibold'>{album.title}</h2>
                    </div>
