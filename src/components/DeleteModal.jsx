...
const DeleteModal = ({ albumToDelete, setDeleteModal }) => {
                ...
                <div className='w-[90%] max-w-[500px] min-h-[400px]'>
                    ...
                    <div className='border-red-500 border-8 select-none rounded-lg bg-white/80 flex p-8 gap-4 w-full flex-col max-h-[80vh]'>
                        ...
                        <div className='flex justify-center gap-8'>
                            <button className='bg-red-500 text-white rounded-lg p-2 px-5 hover:bg-red-600'>Delete</button>
                            <button onClick={()=>setDeleteModal(false)} className='bg-indigo-500 text-white rounded-lg p-2 hover:bg-indigo-600'>Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
